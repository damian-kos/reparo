...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_CallbackEdit        = 1 << 19,  // Callback on any edit (note th t InputText() already returns true on edit, the callback is useful mainly to manipulate the underlying buffer while focus is active)
